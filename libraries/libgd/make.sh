...
package_configure $EXTRACONF --disable-shared --enable-static --with-png=$SYS_PREFIX --with-freetype=$SYS_PREFIX --with-jpeg=$SYS_PREFIX --without-heif --without-tiff --without-webp --without-xpm --without-fontconfig --without-x
