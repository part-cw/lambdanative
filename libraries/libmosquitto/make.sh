...
PKGHASH=408e29db57133b514e48db595af400d8323a1a2c
...
$SYS_CC -DVERSION="\"${VERSION}\"" -DTIMESTAMP="\"${TIMESTAMP}\"" \
  ...
  ../lib/strings_mosq.c ../lib/time_mosq.c ../lib/tls_mosq.c ../lib/util_mosq.c \
  ../lib/util_topic.c ../lib/utf8_mosq.c ../lib/will_mosq.c \
  -I. -I.. -I../lib -I../deps \
